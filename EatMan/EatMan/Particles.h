...
class GroupParticles {
	...
	public:
		GroupParticles(float number, float size, float speed, float lifeTime, float posX, float posY, float dirX, float dirY, float spray, Color color);
		GroupParticles(float number, float sizeMin, float sizeMax, float speedMin,
			float speedMax, float lifeTimeMin, float lifeTimeMax, float posX, float posY, float dirX, float dirY, float spray, Color color);
		~GroupParticles();
